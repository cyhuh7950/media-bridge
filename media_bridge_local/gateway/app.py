...
from media_bridge_local.core.assets import AssetAccessError, AssetStore
from media_bridge_local.core.config_snapshot import SnapshotVerificationError
from media_bridge_local.core.contracts import (
...
from media_bridge_local.core.contracts_v2 import InteropV2Result, provider_call_allowed
from media_bridge_local.core.mcp_server import build_mcp_server
from media_bridge_local.core.service import MediaBridgeService
from media_bridge_local.gateway.auth import CredentialAuthenticationError
from media_bridge_local.gateway.contracts import DataPlaneSubject, DownstreamError
from media_bridge_local.gateway.events import (
    GatewayEvent,
    GatewayEventSink,
...
from media_bridge_local.gateway.rate_limit import CredentialRouteRateLimiter
from media_bridge_local.gateway.runtime import (
    GatewayGeneration,
            ...
            if gateway_response.stream is not None:
                ...
                async def safe_stream() -> AsyncIterator[bytes]:
                    try:
                        ...
                        event = json.dumps(
                            {
                                "type": "media_bridge_local.core.error",
                                "error": {
                        ...
                        yield f"event: media_bridge_local.core.error\ndata: {event}\n\n".encode()
