...
type Profile = { id: string; name: string; analysis_provider_ids: string[]; llm_provider_ids: string[]; strategy: string; enabled: boolean; updated_by?: string; updated_at?: string };
